...
LOGIN_REDIRECT_URL='product-page'
...
LOGGING = {
    ...
    'loggers': {
        ...
        '': {
            'handlers': ['console'],
            'level': 'DEBUG',  # set to DEBUG to see all debug/info logs
            'propagate': True,
        },
        # Django default loggers (optional to set explicitly)
        'django': {
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': True,
